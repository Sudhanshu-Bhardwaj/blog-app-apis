...
public class CommentController {
	...
	public ResponseEntity<ApiResp> deleteComment(@PathVariable Integer commentId) {

		this.commentService.deleteComment(commentId);

		return new ResponseEntity<ApiResp>(new ApiResp("Comment deleted successfully !!", true), HttpStatus.OK);
	}
